...
export { MIFTAH_VERSION, MIFTAH_NAME_AR, MIFTAH_NAME_OFFICIAL_AR, MIFTAH_NOMENCLATURE, STEP0, ASNAN, READY_SENTENCES, SYNTHESIS, SPECIAL_FORMS, CONCLUSION_CHECK, RESCUE_SENTENCE, DRILL, LEVELS, FIVE_COSTLY_ERRORS, RECTO_ERRORS, VERSO_ERRORS, FOOTER_RECTO_AR, FOOTER_VERSO_AR, NARRATIVE_AR, POSITIONING_AR } from './miftahSpec';
