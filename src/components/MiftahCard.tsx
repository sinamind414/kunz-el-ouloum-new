...
.miftah-root{ --gold:#c08a1f; --gold-l:#fdf6e3; --gold-d:#7a5610; --gold-mid:#ecd9a8; --teal:#0e6b6b; --teal-l:#eaf4f4; --teal-mid:#148080; --teal-d:#0a4f4f; --red:#b91c1c; --red-l:#fef2f2; --ink:#151a21; --mute:#475569; --line:#e2e8f0; --bg:#ffffff; --shadow:0 4px 24px rgba(14,107,107,.08),0 1px 4px rgba(0,0,0,.05),0 0 0 1px rgba(226,232,240,.9); --radius:16px; font-family:"Noto Naskh Arabic","Cairo",serif; color:var(--ink); line-height:1.85; font-size:15px; -webkit-font-smoothing:antialiased }
      ...
      <div className="miftah-page">
        ...
        <div className="miftah-key-wrap">
          ...
          <div>
            <div className="miftah-teeth"><span>1 🔍 تعرّف</span><span>2 🔑 أدخل</span><span>3 🔄 أدر</span><span>4 🔓 افتح</span></div>
        ...
        <table>
          ...
          <tbody>
            <tr><td className="c">1</td><td className="c">🔍 تعرّف</td><td>أطوّق <b>الفعل</b> · أسطّر <b>الكلمات المفتاحية</b> · أرقّم إجابتي <b>برقم السؤال</b> (1-أ، 1-ب…) لا غير.</td><td className="corr">إجابة بلا رقم أو تحت رقم خاطئ = <b>0</b> ولو كانت صحيحة. الفعل الخاطئ (وصفتَ بدل أن تفسّر) = تفقد نقطة الفعل كاملة.</td></tr>
        ...
        <h3><span className="num">ب</span> البوابات الثلاث — أقرّر قبل أن أكتب، لا أثناء</h3>
        <div className="miftah-gate"><div className="q">🚪 البوابة 1 — قفل أصلا؟</div><div>هل سطّرتُ في السنّ 1 كلمة: <b>وثيقة / شكل / جدول / منحنى / رسم</b>؟</div><div className="opt a"><b>لا → 🧠 لا قفل</b> : دُرج المعرفة — من تعرّف إلى افتح مباشرة <span className="miftah-path">1 → 4</span></div><div className="opt b"><b>نعم → 🔒 قفل</b> : أمرّ إلى البوابة 2.</div></div>
        ...
        <div className="miftah-gate"><div className="q">⚙️ البوابة 3 — أي حركة؟</div><div className="opt a"><b>📷 الصورة</b> : حلّل، صِف، استخرج، قارن — مسار <span className="miftah-path">1 → 2 → 4</span></div><div className="opt b"><b>🎬 الفيلم</b> : فسّر، اشرح، علّل، استنتج — مسار <span className="miftah-path">1 → 2 → 3 → 4</span></div><div className="opt c"><b>🔨 الحدّاد</b> : اقترح، برّر، ناقض، قدّم حلا — <b>تصنيع</b>: منتج منطقي جديد (فرضية / اقتراح / توصية)، لا جواب واحد في الوثيقة.</div></div>
